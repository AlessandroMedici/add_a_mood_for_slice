class ExtendedSlicing():
    ...
    where in __init__ :
    object ->   must be an sliceable object, like a list, a string, a tuple, a range and bytes and bytearrays
                structures or any self-made object that accepts ":" (slice) operator, like this class.
    ...
    def __getitem__(self, item: tuple) -> object:
        """oBject.__getitem__ reused
        @rtype: object like tuple or lista or other spliceable.
        """
...
def test(n: int = 20) -> None:
    ...
    for step in range(-n, n):  # for all reasonable index step
        ...
        for j in range(n):  # lenghts of objects in test
            ...
            lis: ExtendedSlicing = ExtendedSlicing(a)  # create a new object of this length
